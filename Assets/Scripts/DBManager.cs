...
public class DBManager : MonoBehaviour
{
    ...
    {
        //////创建表
        //string[] colNames = new string[] { "name", "ingredients" };
        //string[] colTypes = new string[] { "string", "string" };
        //CreateTable("dish", colNames, colTypes);

        //////使用泛型创建数据表
        ////CreateTable<T4>();
        //string[] value1 = new string[] { "RamenNoodles","Leak,Raddish,Tomamto,Mushroom,Cabbage,Potato,Redpepper"};
        //string[] value2 = new string[] { "RackofLamb_dish", "Rackoflamb_cooked,Leak,Chilipepper" };
        //InsertValues("dish", value1);
        ...
        //    Debug.Log(item);
        //}
        //foreach (var item in GetDataBySqlQuery("dish", new string[] { "name" }))
        //{
        //    Debug.Log(item);
        //}
    ...
    /// <returns></returns>
    public List<String> SelectData(string tableName, string[] values, string[] fields)
    {
        ...
        //sql = "select ingredients from dish where ( name = 'RamenNoodles');";
